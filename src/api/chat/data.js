...
export const threads = [
    {
        ...
        messages: [
            ...
            },
            {
                ...
                attachments: ['/assets/covers/minimal-1-4x3-small.png'],
                body: 'teste data image',
                contentType: 'image',
                createdAt: subHours(now, 1).getTime(),
                authorId: '5e86805e2bafd54f66cc95c3',
            },
            {
                id: '5e867f2dba984a3f78b33511',
                attachments: [],
                body: 'test audio to text',
                contentType: 'text',
                createdAt: subHours(now, 1).getTime(),
                authorId: '5e86809283e28b96d2d38537',
            },
            {
                id: '5e867f2dba984a3f78233511',
                attachments: ['/assets/audio/1.mp3'],
                body: 'test audio to text',
                contentType: 'audio',
                createdAt: subHours(now, 1).getTime(),
                authorId: '5e86809283e28b96d2d38537',
